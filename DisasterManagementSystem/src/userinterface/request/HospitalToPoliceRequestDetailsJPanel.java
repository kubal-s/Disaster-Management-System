...
public class HospitalToPoliceRequestDetailsJPanel extends javax.swing.JPanel {

    /**
     * Creates new form VictimRequestDetailsJPanel
     */
    private JPanel userProcessContainer;
    private WorkRequest hospitalToPoliceRequest;

    public HospitalToPoliceRequestDetailsJPanel(JPanel userProcessContainer, WorkRequest hospitalToPoliceRequest) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.hospitalToPoliceRequest = hospitalToPoliceRequest;
        initialize();
    }
    ...
    private void initComponents() {
        ...
        txtHospitalSummary = new javax.swing.JLabel();
        txtHospitalDescription = new javax.swing.JLabel();
        ...
        if (preformat != postformat) {
            ...
            if (pjob.printDialog()) {
                try {
                    ...
                    Logger.getLogger(HospitalToPoliceRequestDetailsJPanel.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    ...
    private javax.swing.JLabel txtHospitalDescription;
    private javax.swing.JLabel txtHospitalRequestID;
    private javax.swing.JLabel txtHospitalSummary;
    ...
    private void initialize() {
        WorkRequest victimWorkRequest = ((HospitalToPoliceRequest)hospitalToPoliceRequest).getVictimHelpRequest();
        this.txtHospitalRequestID.setText(String.valueOf(hospitalToPoliceRequest.getRequestID()));
        this.txtSender.setText(hospitalToPoliceRequest.getSender().getUser().getName());
        this.txtHospitalSummary.setText(hospitalToPoliceRequest.getSummary());
        this.txtHospitalDescription.setText(hospitalToPoliceRequest.getDescription());
